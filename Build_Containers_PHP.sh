...
docker buildx build --push --platform linux/arm64,linux/amd64 -t lfsys/php74:latest GeneratePHP7/.
echo ""
...
docker buildx build --push --platform linux/arm64,linux/amd64 -t lfsys/php:latest GeneratePHP8/.
echo ""
